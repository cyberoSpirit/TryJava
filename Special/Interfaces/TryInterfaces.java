...
import Interfaces.constants.AccountType;
import Interfaces.constants.Transaction;
import Interfaces.pojo.Checking;
import Interfaces.pojo.Credit;
import Interfaces.repository.AccountRepository;
import Interfaces.service.AccountService;
import Interfaces.service.CheckingService;
import Interfaces.service.CreditService;

public class TryInterfaces {
    static Path[] paths = new Path[] {Paths.get("Interfaces/data/accounts.txt"), Paths.get("Interfaces/data/transactions.txt")};
