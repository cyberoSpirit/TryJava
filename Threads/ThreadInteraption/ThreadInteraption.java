package ThreadInteraption;

public class ThreadInteraption {

    public static void testThreadInteraption() throws InterruptedException {
        ...
        // Interrupt all players after the time limit
