...
import static Game.constants.Regulation.*;
...
public class Game {
    ...
    public void begin(Team home, Team away) {
        ...
        (
            ...
            "\n - The starting lineup for the home team is: at point guard, " + home.getPlayer(Position.POINT_GUARD)
                + "; at shooting guard, " + home.getPlayer(Position.SHOOTING_GUARD)
                + "; at small forward, " + home.getPlayer(Position.SMALL_FORWARD)
                + "; at power forward, " + home.getPlayer(Position.POWER_FORWARD)
                + "; and at center, " + home.getPlayer(Position.CENTER) + ".\n" +
            "\n - The starting lineup for the visiting team is: at point guard, " + away.getPlayer(Position.POINT_GUARD) 
                + "; at shooting guard, " + away.getPlayer(Position.SHOOTING_GUARD)
                + "; at small forward, " + away.getPlayer(Position.SMALL_FORWARD)
                + "; at power forward, " + away.getPlayer(Position.POWER_FORWARD)
                + "; and at center, " + away.getPlayer(Position.CENTER) + ".\n" +
